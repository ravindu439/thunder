...
type SCIMServiceInterface interface {
	...
	ListSchemas(ctx context.Context, baseURL string) (SCIMSchemaListResponse, *serviceerror.ServiceError)

	GetSchema(ctx context.Context, schemaURN string, baseURL string) (*SCIMSchema, *serviceerror.ServiceError)

	ListResourceTypes(ctx context.Context, baseURL string) (SCIMResourceTypeListResponse, *serviceerror.ServiceError)

	GetResourceType(ctx context.Context, resourceTypeID string, baseURL string) (*SCIMResourceType, *serviceerror.ServiceError)
}
...
// Both ListSchemas and buildUserResourceType use it — neither duplicates the loop.
func (s *scimService) listUserEntityTypeNames(ctx context.Context) ([]string, *serviceerror.ServiceError) {
...
func (s *scimService) ListSchemas(ctx context.Context, baseURL string) (SCIMSchemaListResponse, *serviceerror.ServiceError) {
	logger := log.GetLogger().With(log.String(log.LoggerKeyComponentName, loggerComponentName))
...
func (s *scimService) GetSchema(ctx context.Context, schemaURN string, baseURL string) (*SCIMSchema, *serviceerror.ServiceError) {
	logger := log.GetLogger().With(log.String(log.LoggerKeyComponentName, loggerComponentName))
	...
	if svcErr != nil {
		if svcErr.Code == serviceerror.ErrorUnauthorized.Code {
...
func (s *scimService) ListResourceTypes(ctx context.Context, baseURL string) (SCIMResourceTypeListResponse, *serviceerror.ServiceError) {
...
// RFC 7643 §6
func (s *scimService) GetResourceType(ctx context.Context, resourceTypeID string, baseURL string) (*SCIMResourceType, *serviceerror.ServiceError) {
	logger := log.GetLogger().With(log.String(log.LoggerKeyComponentName, loggerComponentName))
...
// RFC 7643 §6
func (s *scimService) buildUserResourceType(ctx context.Context, baseURL string) (SCIMResourceType, *serviceerror.ServiceError) {
	logger := log.GetLogger().With(log.String(log.LoggerKeyComponentName, loggerComponentName))
