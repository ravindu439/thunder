...
) (*entitytype.EntityTypeListResponse, *serviceerror.ServiceError) {
...
) ([]entitytype.AttributeInfo, *serviceerror.ServiceError) {
	return nil, nil
}
...
func TestBuildCoreUserSchema_IDIsCorURN(t *testing.T) {
	schema := buildCoreUserSchema("https://example.com")
...
func TestMapRawProperty_NumberType(t *testing.T) {
	...
	require.Equal(t, scimAttrTypeInteger, attr.Type)
}
...
func TestMapRawProperty_CredentialField(t *testing.T) {
	...
	require.Equal(t, scimMutabilityImmutable, attr.Mutability)
...
func TestMapEntityTypeToSCIMSchema_InvalidJSON_ReturnsError(t *testing.T) {
	...
	_, err := mapEntityTypeToSCIMSchema(et, "https://example.com")
	require.Error(t, err)
}
...
func TestMapEntityTypeToSCIMSchema_ValidSchema(t *testing.T) {
	...
	schema, err := mapEntityTypeToSCIMSchema(et, "https://example.com")
...
func TestGetSchema_CoreUserURN_ReturnsStaticSchema(t *testing.T) {
	...
	schema, svcErr := svc.GetSchema(context.Background(), SCIMCoreUserSchemaURN, "https://example.com")
	require.Nil(t, svcErr)
...
func TestGetSchema_UnknownURN_Returns404(t *testing.T) {
	svc := newSCIMService(nil, nil, config.SCIMConfig{})
	schema, svcErr := svc.GetSchema(context.Background(), "urn:unknown:schema", "https://example.com")
...
func (s *notFoundEntityTypeService) GetEntityTypeByName(
	...
	return nil, &serviceerror.ServiceError{Code: "ET-404"}
}
...
func TestListSchemas_IncludesCoreUserSchema(t *testing.T) {
	...
	resp, svcErr := svc.ListSchemas(context.Background(), "https://example.com")
	require.Nil(t, svcErr)
...
func TestGetSchema_EmptyURN_Returns404(t *testing.T) {
	svc := newSCIMService(nil, nil, config.SCIMConfig{})
	schema, svcErr := svc.GetSchema(context.Background(), "   ", "https://example.com")
	require.Nil(t, schema)
	require.NotNil(t, svcErr)
	require.Equal(t, ErrorSchemaNotFound.Code, svcErr.Code)
}
...
func TestGetSchema_AuthErrorFromResolve_PropagatesUnchanged(t *testing.T) {
	...
	require.Nil(t, schema)
	require.NotNil(t, svcErr)
	require.Equal(t, serviceerror.ErrorUnauthorized.Code, svcErr.Code)
}
...
func (s *authErrorEntityTypeService) GetEntityTypeList(
	...
	authErr := serviceerror.ErrorUnauthorized
	return nil, &authErr
}
...
func (s *listErrorEntityTypeService) GetEntityTypeList(
	...
	return nil, &serviceerror.ServiceError{Code: "ET-500"}
}
...
func (s *nonAuthListErrorEntityTypeService) GetEntityTypeList(
	...
	return nil, &serviceerror.ServiceError{Code: "ET-DB-ERR"}
}
